...
SWIFT_CLASS("_TtC13MOONGraphView13MOONGraphView")
@interface MOONGraphView : NSView
- (void)awakeFromNib;
...
@property (nonatomic) NSInteger maxSamples;
...
@property (nonatomic) NSInteger numberOfGraphs;
